...
def iniciar_combate(screen):
    ...
    preguntas_por_monstruo = {
        ...
        "negatrix": [
            ...
            ("-20 + 5?", ["A)-15", "B)-25", "C)15", "D)-10"], "A"),
            ("-8 + -2?", ["A)-10", "B)-6", "C)6", "D)10"], "A"),
            ("-12 - 3?", ["A)-9", "B)-12", "C)-15", "D)15"], "C"),
            ("-6 x -2?", ["A)-12", "B)12", "C)-8", "D)8"], "B"),
            ("-18 / 3?", ["A)-6", "B)6", "C)-15", "D)15"], "A"),
            ("7 - 12?", ["A)5", "B)-5", "C)19", "D)-19"], "B"),
            ("Que propiedad tienen los enteros?", ["A)son siempre positivos", "B)no pueden ser negativos", "C)incluyen negativos, positivos y 0", "D)solo se escriben como fracciones"], "C"),
            ("Cual es un numero entero negativo?", ["A)4", "B)0", "C)-9", "D)1/2"], "C"),
            ("El opuesto de -8 es?", ["A)-8", "B)0", "C)8", "D)16"], "C"),
            ("-4 + 4?", ["A)-8", "B)0", "C)4", "D)8"], "B")
        ],

        "fracton": [
            ("1/2 + 1/2?", ["A)1", "B)2", "C)1/2", "D)0"], "A"),
            ("3/4 de 20?", ["A)5", "B)10", "C)15", "D)20"], "C"),
            ("1/3 + 1/3?", ["A)1", "B)2/3", "C)1/3", "D)3/3"], "B"),
            ("1/4 + 1/4?", ["A)1/2", "B)1/4", "C)2", "D)1"], "A"),
            ("2/5 + 1/5?", ["A)1/5", "B)2/5", "C)3/5", "D)5/5"], "C"),
            ("1/2 de 30?", ["A)10", "B)15", "C)20", "D)25"], "B"),
            ("2/3 de 12?", ["A)4", "B)6", "C)8", "D)10"], "C"),
            ("Que fraccion equivale a 1/2?", ["A)2/4", "B)1/3", "C)3/5", "D)4/2"], "A"),
            ("Cual es una caracteristica de los numeros racionales?", ["A)No pueden expresarse como fraccion", "B)Tienen infinitos decimales sin patron", "C)Pueden escribirse como fraccion", "D)Siempre son negativos"], "C"),
            ("0,5 se puede escribir como?", ["A)1/2", "B)1/5", "C)5/1", "D)2/1"], "A"),
            ("1/5 + 3/5?", ["A)2/5", "B)3/5", "C)4/5", "D)5/5"], "C"),
        ...
        "realion": [
            ...
            ("2 elevado a 2?", ["A)2", "B)4", "C)6", "D)8"], "B"),
            ("Pi es aproximadamente?", ["A)2.14", "B)5.12", "C)3.14", "D)4.20"], "C"),
            ("Que incluye el conjunto de los numeros reales?", ["A)Solo positivos", "B)Solo enteros", "C)Racionales e irracionales", "D)Solo imaginarios"], "C"),
            ("Raiz de 81?", ["A)7", "B)8", "C)9", "D)10"], "C"),
            ("3 elevado a 2?", ["A)6", "B)9", "C)12", "D)18"], "B"),
            ("Cual pertenece a los reales?", ["A)5", "B)1/2", "C)pi", "D)Todas son correctas"], "D"),
            ("-4 es un numero real?", ["A)Si", "B)No", "C)Solo si es positivo", "D)Solo si es fraccion"], "A"),
            ("0 es un numero real?", ["A)Si", "B)No", "C)Solo en naturales", "D)Solo en irracionales"], "A"),
            ("2,5 es un numero real?", ["A)Si", "B)No", "C)Solo si es entero", "D)No existe"], "A"),
            ("Raiz de 16?", ["A)2", "B)4", "C)8", "D)16"], "B"),
            ("5 elevado a 2?", ["A)10", "B)15", "C)20", "D)25"], "D")
        ]
    }
